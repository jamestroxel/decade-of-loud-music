...
let filter = d3.select("defs").append("filter").attr("id", "dropShadow");
filter
...
d3.json("data/monthly.json").then((data) => {
  ...
  var wrapper = d3.select(".page-wrap").on("scroll", mouseout);
